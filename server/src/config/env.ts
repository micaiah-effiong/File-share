...
const config: ServerConfig = {
	...
	DB_STORAGE: path.resolve(process.env.DB_STORAGE || process.cwd(), "dist", "data", "database.sqlite"),
	FILE_STORAGE_PATH: path.resolve(process.env.FILE_STORAGE_PATH || process.cwd(), "dist", "files"),
