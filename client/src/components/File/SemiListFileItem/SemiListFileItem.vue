<template>
	<div
		class="w-auto min-w-fix max-h-fit h-fit rounded-lg shadow-sm mono:bg-ash-normal mono:text-ash-accent mono:hover:bg-ash-secondary mono:hover:transition-colors transition-colors"
	>
		<div class="flex w-full p-3 rounded-md">
			<div class="flex gap-3 w-full text-left">
				<div class="flex justify-center flex-col">
					<span>
						<DocumentIcon class="h-5 md:h-10 text-ocean-blue-secondary" />
					</span>
				</div>

				<div class="text-[0.8rem] md:w-2/6 w-4/6 max-w-min text-left text-ocean-blue-dark flex justify-center flex-col">
					<span class="font-semibold truncate overflow-hidden">
						{{ file.short }}
					</span>
