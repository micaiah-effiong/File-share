<template>
	<nav class="h-full flex-shrink-0 w-20 min-w-20 py-7 bg-white hidden md:block shadow-md shadow-ocean-blue-accent">
		<div class="grid h-full overflow-auto gap-6">
			...
			<div class="flex justify-center self-end">
				<div class="grid border-ocean-blue-secondary border bg-ocean-blue-light rounded-md">
					<div class="w-11 h-10 justify-center grid text-ocean-blue-dark items-center">
						<button>
					...
					<div class="w-11 h-10 justify-center grid items-center">
						<button>
							<img
								...
								alt="avatar"
								class="w-8 h-8 border border-ocean-blue-secondary text-xs rounded-md"
							/>
						</button>
					</div>
				</div>
