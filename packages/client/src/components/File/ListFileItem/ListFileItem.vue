<template>
	<div
		class="w-full min-w-min max-h-fit h-fit rounded-lg shadow-sm mono:bg-ash-normal mono:text-ash-accent mono:hover:bg-ash-secondary mono:hover:transition-colors transition-colors"
	>
