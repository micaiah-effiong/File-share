<template>
	<div
		class="min-w-auto max-h-fit h-auto rounded-lg shadow-sm mono:bg-ash-normal mono:text-ash-accent mono:hover:bg-ash-secondary mono:hover:transition-colors transition-colors"
	>
		<div class="grid w-full p-3 h-full rounded-md">
			<div>
				...
				<div class="grid gap-3 pb-3 md:py-3 justify-center text-center">
					...
					<div class="text-[0.8rem] break-all text-ocean-blue-dark font-semibold">
						{{ file.short }}
					</div>
				</div>
			</div>
